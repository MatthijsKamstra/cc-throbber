...
var Main = function() {
	this.ccTypeArray = [test_CCThrobber,test_CCListThrobber];
	var _gthis = this;
	window.document.addEventListener("DOMContentLoaded",function(event) {
		window.console.log("" + model_constants_App.NAME + " Dom ready :: build: " + "2020-01-31 19:18:13");
		_gthis.setupArt();
		_gthis.setupNav();
	});
};
...
Main.prototype = {
	...
	,changeHash: function() {
		...
		var tmp = c.__name__;
		window.location.hash = StringTools.replace(tmp,"test.","");
	}
	,__class__: Main
};
Math.__name__ = "Math";
	...
	,update: function() {
		...
		if(this.settings.get_type() == "svg") {
			...
			while(_g2 < _g11) {
				...
				haxe_Log.trace(base1.type,{ fileName : "Sketcher.hx", lineNumber : 454, className : "Sketcher", methodName : "update"});
...
cc_draw_Text.prototype = {
	...
	,textAlign: function(textAnchorType) {
		this._textAlign = textAnchorType;
		return this;
	}
	,leftAlign: function() {
		this._textAlign = "start";
	...
	,draw: function() {
		if(this._ctx != null) {
			...
			text.set_textAnchor(this._textAlign);
			text.set_dominantBaseline(this._textBaseline);
...
$hxClasses["cc.model.constants.Paper"] = cc_model_constants_Paper;
...
draw_Base.prototype = {
	...
	,clone: function() {
		haxe_Log.trace("WIP",{ fileName : "draw/Base.hx", lineNumber : 131, className : "draw.Base", methodName : "clone"});
...
$hxClasses["draw.Circle"] = draw_Circle;
...
$hxClasses["draw.Gradient"] = draw_Gradient;
...
$hxClasses["draw.Group"] = draw_Group;
...
draw_Line.prototype = $extend(draw_Base.prototype,{
	...
	,__class__: draw_Line
	,__properties__: $extend(draw_Base.prototype.__properties__,{set_y2:"set_y2",get_y2:"get_y2",set_x2:"set_x2",get_x2:"get_x2"})
});
...
draw_PolyLine.prototype = $extend(draw_Base.prototype,{
	svg: function(settings) {
		...
		if(this.getTransform() != "") {
			haxe_Log.trace(this.getTransform(),{ fileName : "draw/PolyLine.hx", lineNumber : 33, className : "draw.PolyLine", methodName : "svg"});
			this.xml.set("transform",this.getTransform());
		}
		return haxe_xml_Printer.print(this.xml);
	}
...
$hxClasses["draw.Rectangle"] = draw_Rectangle;
...
var test_VBase = function(set) {
	...
	if(set == null) {
		...
		this.settings.set_elementID("sketcher-svg-wrapper");
	} else {
		this.settings = set;
		this.cx = this.settings.get_width() / 2;
		this.cy = this.settings.get_height() / 2;
	}
	this.isDebug = true;
	this.setupKey();
	SketcherBase.call(this,this.settings);
};
$hxClasses["test.VBase"] = test_VBase;
test_VBase.__name__ = "test.VBase";
test_VBase.__super__ = SketcherBase;
test_VBase.prototype = $extend(SketcherBase.prototype,{
	setupKey: function() {
		var _gthis = this;
		window.console.groupCollapsed("Keyboard Shortcuts are activated");
		window.console.info("- [cmd + r] = reload page\n- [cmd + s] = save jpg\n- [cmd + shift + s] = save png\n- [cmd + ctrl + s] = save transparant png\n- [cmd + alt + s] = save svg");
		window.console.groupEnd();
		window.addEventListener(Global.KEY_DOWN,function(e) {
			if(e.metaKey == true && e.key == "r") {
				haxe_Log.trace("cmd + r",{ fileName : "src/test/VBase.hx", lineNumber : 69, className : "test.VBase", methodName : "setupKey"});
				window.location.reload();
			}
			if(e.metaKey == true && e.key == "s" && e.shiftKey == false && e.ctrlKey == false) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + s",{ fileName : "src/test/VBase.hx", lineNumber : 76, className : "test.VBase", methodName : "setupKey"});
				var tmp = _gthis.getSvg();
				var tmp1 = _gthis.getFileName();
				_gthis.svg2Canvas(tmp,true,tmp1);
			}
			if(e.metaKey == true && e.key == "s" && e.shiftKey == true) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + shift + s",{ fileName : "src/test/VBase.hx", lineNumber : 84, className : "test.VBase", methodName : "setupKey"});
				var tmp2 = _gthis.getSvg();
				var tmp3 = _gthis.getFileName();
				_gthis.svg2Canvas(tmp2,false,tmp3);
			}
			if(e.metaKey == true && e.key == "s" && e.ctrlKey == true) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + ctrl + s",{ fileName : "src/test/VBase.hx", lineNumber : 91, className : "test.VBase", methodName : "setupKey"});
				var tmp4 = _gthis.getSvg();
				var tmp5 = _gthis.getFileName();
				_gthis.svg2Canvas(tmp4,false,tmp5,true);
			}
			if(e.metaKey == true && (e.code == "KeyS" && e.altKey == true)) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + alt + s",{ fileName : "src/test/VBase.hx", lineNumber : 98, className : "test.VBase", methodName : "setupKey"});
				var tmp6 = _gthis.getSvg().outerHTML;
				var tmp7 = "" + _gthis.getFileName() + ".svg";
				_gthis.downloadTextFile(tmp6,tmp7);
			}
	...
	,getFileName: function() {
		if(this.patternName == "" && this.description == "") {
			this.patternName = "PatternDesign - MatthijsKamstra";
	...
	,svg2Canvas: function(svg,isJpg,filename,isTransparant) {
		if(isTransparant == null) {
			isTransparant = false;
		}
		if(isJpg == null) {
		...
		image.onload = function() {
			...
			cc_tool_ExportFile.downloadImageBg(ctx,isJpg,filename,isTransparant);
		};
	...
	,__class__: test_VBase
});
var test_CCListThrobber = function() {
	this.frameCounter = 0;
	...
	cc_draw_Text.embedGoogleFont("Inconsolata:400,700",$bind(this,this.onEmbedHandler));
	test_VBase.call(this);
};
$hxClasses["test.CCListThrobber"] = test_CCListThrobber;
test_CCListThrobber.__name__ = "test.CCListThrobber";
test_CCListThrobber.__super__ = test_VBase;
test_CCListThrobber.prototype = $extend(test_VBase.prototype,{
	onEmbedHandler: function(e) {
		haxe_Log.trace("onEmbedHandler: \"" + e + "\"",{ fileName : "src/test/CCListThrobber.hx", lineNumber : 38, className : "test.CCListThrobber", methodName : "onEmbedHandler"});
	...
	,setup: function() {
		this.description = "NineThrobber";
		if(this.isDebug) {
			window.console.info("SETUP :: " + this.toString() + " -> override public function setup()");
		}
		this.frameCounter = 0;
	...
	,initElements: function() {
		window.console.log("initElement");
		this.canvas = window.document.createElement("canvas");
		this.canvas.width = this.settings.get_width();
		this.canvas.height = this.settings.get_height();
		this.ctx = this.canvas.getContext("2d",null);
		var downloadButton = window.document.createElement("a");
		downloadButton.className = "btn";
		downloadButton.href = "#";
		downloadButton.innerText = "download";
		window.document.body.appendChild(downloadButton);
		this.videoExport = new sketcher_export_VideoExport();
		this.videoExport.setCanvas(this.canvas);
		this.videoExport.setDownload(downloadButton);
		this.videoExport.setup();
	}
	,convertSVG2Canvas: function() {
		var _gthis = this;
		var image = new Image();
		image.onload = function() {
			var _gthis1 = _gthis.ctx;
			var tmp = _gthis.settings.get_width();
			var tmp1 = _gthis.settings.get_height();
			_gthis1.drawImage(image,0,0,tmp,tmp1);
		};
		image.onerror = function(e) {
			window.console.warn(e);
		};
		var tmp2 = window.btoa(this.sketch.svg);
		image.src = "data:image/svg+xml;base64," + tmp2;
	}
	,initRecording: function() {
		this.startTimer = Date.now() / 1000;
		this.isStartTimerSet = true;
		this.videoExport.start();
		haxe_Log.trace("initRecording: " + this.frameCounter + ", " + this.frameTotal,{ fileName : "src/test/CCListThrobber.hx", lineNumber : 126, className : "test.CCListThrobber", methodName : "initRecording"});
	}
	,drawShape: function() {
		this.sketch.clear();
		var gradient = this.sketch.makeGradient("#B993D6","#8CA6DB");
		gradient.set_id("dirty-fog");
		var bg = this.sketch.makeRectangle(0,0,Global.w,Global.h,false);
		bg.set_id("bg color");
		var bg1 = this.sketch.makeRectangle(0,0,Global.w,Global.h,false);
		bg1.set_id("gradient color yoda");
		bg1.set_fillGradientColor("dirty-fog");
		var bgGroup = this.sketch.makeGroup([bg,bg1]);
		bgGroup.set_id("sketch background");
		bgGroup.set_fill(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.BLACK));
		var _posArray = [];
		var _g = 0;
		...
		while(_g < _g1) {
			...
			var c = this.sketch.makeCircle(p.x,p.y,this.radiusSmall);
			_posArray.push(c);
		}
		if(this.isDebug) {
			util_TestUtil.gridDots(this.sketch,this.grid);
		}
		...
		this.throbberFour(this.grid.array[3],pct);
		this.throbberFive(this.grid.array[4],pct);
		this.throbberSix(this.grid.array[5],pct);
		this.throbberSeven(this.grid.array[6],pct);
		this.throbberEight(this.grid.array[7],pct);
		this.throbberNine(this.grid.array[8],pct);
		var posG = this.sketch.makeGroup(_posArray);
		posG.set_id("position of throbbers");
		posG.set_fillColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		posG.set_opacity(0);
		this.sketch.update();
	...
	,throbberOne: function(p,pct) {
		...
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		var dashNoLine = omtrek - dashLine;
		var circle = this.sketch.makeCircle(p.x,p.y,_r);
		circle.set_fillOpacity(0);
		circle.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle.set_strokeWeight(_stroke);
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
	}
	,throbberTwo: function(p,pct) {
		var _r = this.radiusSmall * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		var dashNoLine = omtrek - dashLine;
		var circle = this.sketch.makeCircle(p.x,p.y,_r);
		circle.set_fillOpacity(0);
		circle.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle.set_strokeWeight(this.radiusSmall);
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
	}
	,throbberThree: function(p,pct) {
		var _stroke = 30;
		var _r = this.radiusSmall - _stroke * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		...
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
		var circle2 = this.sketch.makeCircle(p.x,p.y,_r);
		circle2.set_fillOpacity(0);
		circle2.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle2.set_strokeWeight(_stroke);
		circle2.set_strokeOpacity(0.2);
		circle2.setRotate(-90,p.x,p.y);
	}
	,throbberFour: function(p,pct) {
		var _stroke = 30;
		var _r = this.radiusSmall - _stroke * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		...
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
		var circle2 = this.sketch.makeCircle(p.x,p.y,_r - _stroke * 0.5);
		circle2.set_fillOpacity(0);
		circle2.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle2.set_strokeWeight(1);
		circle2.set_strokeOpacity(.5);
		var circle3 = this.sketch.makeCircle(p.x,p.y,_r + _stroke * 0.5);
		circle3.set_fillOpacity(0);
		circle3.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle3.set_strokeWeight(1);
		circle3.set_strokeOpacity(.5);
	}
	,throbberFive: function(p,pct) {
		var _stroke = 3;
		var _r = this.radiusSmall;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		var dashNoLine = omtrek - dashLine;
		var circle = this.sketch.makeCircle(p.x,p.y,_r);
		...
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
		var dot = this.sketch.makeCircle(p.x,p.y,10);
		dot.set_fillOpacity(0);
		dot.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		dot.set_strokeWeight(_stroke);
		dot.setRotate(-90 + 360 * pct,p.x,p.y);
		dot.setPosition(_r,0);
	}
	,throbberSix: function(p,pct) {
		var _r = this.radiusSmall * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		var dashNoLine = omtrek - dashLine;
		...
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
		var circle1 = this.sketch.makeCircle(p.x,p.y,this.radiusSmall * .85);
		circle1.set_fillColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		circle1.set_fillOpacity(.9);
	}
	,throbberSeven: function(p,pct) {
		var _stroke = 20;
		var _r = this.radiusSmall - _stroke * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		...
		circle.set_dash([dashLine,dashNoLine]);
		circle.setRotate(-90,p.x,p.y);
		var circle1 = this.sketch.makeCircle(p.x,p.y,_r - _stroke * 0.6);
		circle1.set_fillColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		var total = 100;
		var str = Std.string(Math.ceil(100 * pct)) + "%";
		var Text1 = new cc_draw_Text(this.sketch,str);
		var _this = Text1;
		_this._font = StringTools.replace(StringTools.replace("Inconsolata",";",""),"+"," ");
		var _this1 = _this;
		_this1.set__size(50);
		if(_this1.get__leading() == null) {
			_this1.set__leading(50);
		}
		var _this2 = _this1;
		_this2._fontWeight = "400";
		var _this3 = _this2;
		_this3._color = cc_util_ColorUtil.BLACK;
		_this3.set__alpha(cc_util_MathUtil.clamp(1,0,1));
		var _this4 = _this3;
		_this4._textAlign = "middle";
		var _this5 = _this4;
		_this5._textBaseline = "middle";
		var _this6 = _this5;
		var y = p.y + 3;
		_this6.set__x(p.x);
		_this6.set__y(y);
		...
		if(_this7._ctx != null) {
			...
			var tmp1 = "" + _this7._css + " " + _this7.get__size() + "px " + _this7._font;
			_this7._ctx.font = StringTools.ltrim(tmp1);
			...
			if(!isLines) {
				...
				var _g = 0;
				var _g1 = _this7._lineArray.length;
				while(_g < _g1) {
					var i = _g++;
					var line = _this7._lineArray[i];
					_this7._ctx.fillText(line,0,i * _this7.get__leading());
				}
			}
			_this7._ctx.restore();
			_this7._ctx.fillStyle = previousColor;
		} else {
			var isLines1 = _this7.splitLines();
			var text = _this7._sketcher.makeText(_this7._text,_this7.get__x(),_this7.get__y());
			if(_this7.get__id() != null) {
				text.set_id(_this7.get__id());
			}
			if(_this7._color != null) {
				text.set_fill(cc_util_ColorUtil.getColourObj(_this7._color,_this7.get__alpha()));
			}
			text.set_fontSize("" + _this7.get__size() + "px");
			text.set_fontFamily("" + _this7._font);
			text.set_textAnchor(_this7._textAlign);
			text.set_dominantBaseline(_this7._textBaseline);
			if(_this7.fontWeight != null) {
				text.set_fontWeight("" + _this7._fontWeight);
			}
			_this7._hackText = text;
		}
		var txt1 = _this7;
	}
	,throbberEight: function(p,pct) {
		var _stroke = 30;
		var _r = this.radiusSmall - _stroke * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		...
		var dashed = this.sketch.makeCircle(p.x,p.y,_r);
		dashed.set_fillOpacity(0);
		dashed.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		dashed.set_strokeWeight(_stroke);
		dashed.set_dash([dashStroke,noDash]);
		dashed.setRotate(-90,p.x,p.y);
	}
	,throbberNine: function(p,pct) {
		var _stroke = 30;
		var _r = this.radiusSmall * 0.5;
		var omtrek = cc_util_MathUtil.circumferenceCircle(_r);
		var dashLine = omtrek * pct;
		...
		var dashStroke = 2;
		var noDash = omtrek / devide - dashStroke;
		var dashed = this.sketch.makeCircle(p.x,p.y,this.radiusSmall - _stroke * 0.5);
		dashed.set_fillOpacity(0);
		dashed.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		dashed.set_strokeWeight(_stroke);
		dashed.set_dash([dashStroke,noDash]);
	...
	,draw: function() {
		if(this.isDebug) {
			haxe_Log.trace("DRAW :: " + this.toString() + " -> override public function draw()",{ fileName : "src/test/CCListThrobber.hx", lineNumber : 447, className : "test.CCListThrobber", methodName : "draw"});
		}
	...
	,__class__: test_CCListThrobber
});
var test_CCThrobber = function() {
	this.isStartTimerSet = false;
	this.frameCounter = 0;
	this.frameTotal = 3600;
	this.FPS = 60;
	this.seconds = 60;
	this.dashLine = 0.0;
	this.radius = 180;
	this.isGoogleFontLoaded = false;
	cc_draw_Text.embedGoogleFont("Six+Caps|Medula+One|Dosis:200,300,400,500,600,700,800|Source+Code+Pro:200,300,400,500,600,700,900|Roboto+Mono:100,100i,300,300i,400,400i,500,500i,700,700i",$bind(this,this.onEmbedHandler));
	test_VBase.call(this);
};
$hxClasses["test.CCThrobber"] = test_CCThrobber;
test_CCThrobber.__name__ = "test.CCThrobber";
test_CCThrobber.__super__ = test_VBase;
test_CCThrobber.prototype = $extend(test_VBase.prototype,{
	initElements: function() {
		window.console.log("initElement");
		this.canvas = window.document.createElement("canvas");
		this.canvas.width = this.settings.get_width();
	...
	,drawShape: function() {
		if(!this.isStartTimerSet) {
			this.initDraw();
		}
		this.sketch.clear();
		var dashBumb = this.omtrek / this.frameTotal;
		if(this.isDebug) {
			this.dashLine = this.omtrek * 0.66;
		}
		var dashNoLine = this.omtrek - this.dashLine;
		var gradient = this.sketch.makeGradient("#FF0099","#493240");
		gradient.set_id("yoda-gradient");
		var bg = this.sketch.makeRectangle(0,0,Global.w,Global.h,false);
		bg.set_id("bg color");
		var bg1 = this.sketch.makeRectangle(0,0,Global.w,Global.h,false);
		bg1.set_id("gradient color yoda");
		bg1.set_fillGradientColor("yoda-gradient");
		var bgGroup = this.sketch.makeGroup([bg,bg1]);
		bgGroup.set_id("sketch background");
		bgGroup.set_fill(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.BLACK));
		var cirkel = this.sketch.makeCircle(this.get_w2(),this.get_h2(),this.radius);
		cirkel.set_fillOpacity(0);
		cirkel.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		cirkel.set_strokeWeight(30);
		cirkel.set_dash([this.dashLine,dashNoLine]);
		cirkel.setRotate(-90,this.get_w2(),this.get_h2());
		var c = this.sketch.makeCircle(this.get_w2(),this.get_h2(),this.radius * .85);
		c.set_fillOpacity(1);
		c.set_fillColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.WHITE));
		var str = Std.string(Math.ceil((this.frameTotal - this.frameCounter) / this.FPS));
		var Text1 = new cc_draw_Text(this.sketch,str);
		var _this = Text1;
		_this._font = StringTools.replace(StringTools.replace("Source+Code+Pro",";",""),"+"," ");
		var _this1 = _this;
		...
		var txt1 = _this7;
		if(this.isDebug) {
			var x1 = this.sketch.makeX(this.get_w2(),this.get_h2());
		}
		this.sketch.update();
		this.convertSVG2Canvas();
		if(this.frameCounter >= this.frameTotal) {
		...
		this.dashLine += dashBumb;
		this.frameCounter++;
	}
	,setup: function() {
		this.description = "Throbber SVG ";
		haxe_Log.trace("SETUP :: " + this.toString() + " -> override public function setup()",{ fileName : "src/test/CCThrobber.hx", lineNumber : 186, className : "test.CCThrobber", methodName : "setup"});
		this.frameCounter = 0;
		this.frameTotal = this.FPS * this.seconds;
		this.omtrek = cc_util_MathUtil.circumferenceCircle(this.radius);
		this.initElements();
	}
	,onEmbedHandler: function(e) {
		haxe_Log.trace("onEmbedHandler: \"" + e + "\"",{ fileName : "src/test/CCThrobber.hx", lineNumber : 196, className : "test.CCThrobber", methodName : "onEmbedHandler"});
		this.isGoogleFontLoaded = true;
		haxe_Timer.delay(function() {
		},500);
	}
	...
	,__class__: test_CCThrobber
});
var util_TestUtil = function() {
};
$hxClasses["util.TestUtil"] = util_TestUtil;
util_TestUtil.__name__ = "util.TestUtil";
util_TestUtil.gridDots = function(sketch,grid) {
	var _circlesArray = [];
	var _g = 0;
	var _g1 = grid.array.length;
	while(_g < _g1) {
		...
		circle.set_fillColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.PINK,1));
		_circlesArray.push(circle);
	}
	var rect = sketch.makeRectangle(grid.x,grid.y,grid.width,grid.height,false);
	rect.set_strokeWeight(1);
	rect.set_strokeColor(cc_util_ColorUtil.getColourObj(cc_util_ColorUtil.GRAY,0.5));
...
util_TestUtil.prototype = {
	__class__: util_TestUtil
};
...
model_constants_App.NAME = "[cc-throbber]";
Main.main();
})(typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : this);

//# sourceMappingURL=cc_throbber.js.map