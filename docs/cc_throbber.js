...
var SketcherBase = function(settings) {
	...
	if(settings != null && settings.get_element() != null) {
		haxe_Log.trace(settings.get_element(),{ fileName : "SketcherBase.hx", lineNumber : 30, className : "SketcherBase", methodName : "new"});
	}
...
SketcherBase.prototype = {
	...
	,setup: function() {
		if(this.isDebug) {
			haxe_Log.trace("SETUP :: " + this.toString() + " -> override public function draw()",{ fileName : "SketcherBase.hx", lineNumber : 92, className : "SketcherBase", methodName : "setup"});
		}
	}
	,draw: function() {
		if(this.isDebug) {
			haxe_Log.trace("DRAW :: " + this.toString() + " -> override public function draw()",{ fileName : "SketcherBase.hx", lineNumber : 100, className : "SketcherBase", methodName : "draw"});
		}
	}
	,__export: function() {
	}
...
sketcher_draw_Circle.prototype = $extend(draw_Base.prototype,{
	...
	,ctx: function(ctx) {
		...
		ctx.fillStyle = cc_util_ColorUtil.getColourObj(_fillColor,this.get_fillOpacity());
...
sketcher_draw_Group.prototype = $extend(draw_Base.prototype,{
	...
	,test: function() {
		haxe_Log.trace("test if casting works",{ fileName : "sketcher/draw/Group.hx", lineNumber : 92, className : "sketcher.draw.Group", methodName : "test"});
	}
	,get_arr: function() {
		return this.arr;
	}
...
sketcher_draw_Text.prototype = $extend(draw_Base.prototype,{
	...
	,convertTextAlign: function() {
		...
		default:
			this.set_textAnchor("start");
			haxe_Log.trace("case '" + this._textAlign + "': trace ('" + this._textAlign + "');",{ fileName : "sketcher/draw/Text.hx", lineNumber : 172, className : "sketcher.draw.Text", methodName : "convertTextAlign"});
		}
	}
	,convertTextBaseline: function() {
		...
		default:
			...
			haxe_Log.trace("case '" + this._textBaseline + "': trace ('" + this._textBaseline + "');",{ fileName : "sketcher/draw/Text.hx", lineNumber : 186, className : "sketcher.draw.Text", methodName : "convertTextBaseline"});
		}
	}
...
var test_VBase = function(set) {
	this.forgroundColor = sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.BLACK);
	this.backgroundColor = sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE);
	this.description = "";
	this.patternName = "";
	...
	if(set == null) {
		...
		this.settings.set_elementID("sketcher-canvas-wrapper");
	} else {
		this.settings = set;
	...
	setupKey: function() {
		...
		window.addEventListener(Globals.KEY_DOWN,function(e) {
			if(e.metaKey == true && e.key == "r") {
				haxe_Log.trace("cmd + r",{ fileName : "src/test/VBase.hx", lineNumber : 75, className : "test.VBase", methodName : "setupKey"});
				window.location.reload();
			}
			if(e.metaKey == true && e.key == "s" && e.shiftKey == false && e.ctrlKey == false) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + s",{ fileName : "src/test/VBase.hx", lineNumber : 82, className : "test.VBase", methodName : "setupKey"});
			...
			if(e.metaKey == true && e.key == "s" && e.shiftKey == true) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + shift + s",{ fileName : "src/test/VBase.hx", lineNumber : 90, className : "test.VBase", methodName : "setupKey"});
			...
			if(e.metaKey == true && e.key == "s" && e.ctrlKey == true) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + ctrl + s",{ fileName : "src/test/VBase.hx", lineNumber : 97, className : "test.VBase", methodName : "setupKey"});
			...
			if(e.metaKey == true && (e.code == "KeyS" && e.altKey == true)) {
				e.preventDefault();
				e.stopPropagation();
				haxe_Log.trace("cmd + alt + s",{ fileName : "src/test/VBase.hx", lineNumber : 104, className : "test.VBase", methodName : "setupKey"});
...
var test_TestThrobber = function() {
	this.frameCounter = 0;
...
$hxClasses["test.TestThrobber"] = test_TestThrobber;
test_TestThrobber.__name__ = "test.TestThrobber";
...
test_TestThrobber.prototype = $extend(test_VBase.prototype,{
	...
	,drawShape: function() {
		...
		bg.set_id("bg color");
		var bg1 = this.sketch.makeRectangle(0,0,Globals.w,Globals.h,false);
		...
		if(this.settings.get_type().toLowerCase() == "canvas") {
			var gradient1 = this.sketch.makeGradient("#B993D6","#8CA6DB");
		}
		var _posArray = [];
		var _g = 0;
	...
	,throbberOne: function(p,pct) {
		...
		circle.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
	...
	,throbberThree: function(p,pct) {
		...
		circle2.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
	...
	,throbberFour: function(p,pct) {
		...
		circle3.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
	...
	,throbberFive: function(p,pct) {
		...
		dot.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
	...
	,throbberSix: function(p,pct) {
		...
		circle1.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
	...
	,throbberSeven: function(p,pct) {
		...
		var text = this.sketch.makeText(str,p.x,p.y + 3);
		text.set_fontFamily("Inconsolata");
		text.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.BLACK));
		text.set_fontSize("50");
		text.set_fontWeight("400");
		text.set_textAlign("center");
		text.set_alignmentBaseline("middle");
	}
	,throbberEight: function(p,pct) {
		...
		dashed.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
